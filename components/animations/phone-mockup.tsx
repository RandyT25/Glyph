...
export default function PhoneMockup({ className }: PhoneMockupProps) {
  ...
  return (
    <motion.div
      ...
      style={{ width: 260 }}
    >
      {/* Phone frame — overflow:hidden clips the NFC ripple to phone shape */}
      <div
      ...
      >
        ...
        <div className="absolute inset-0 bg-[#09090B] pt-10 flex flex-col">
          ...
          <div className="flex-1 flex flex-col px-5 pt-3 pb-4">
            ...
            {/* Stamp progress */}
            <div className="bg-[#111113] rounded-2xl p-3 border border-[#27272A] mb-3">
              <StampProgress filledCount={7} animated={false} rewardLabel="Free Coffee" />
            </div>

            {/* Progress label */}
            <div className="bg-[#4F46E5]/10 border border-[#4F46E5]/20 rounded-xl px-3 py-2.5 mb-3">
              <p className="text-[#6366F1] text-[11px] font-semibold text-center">
          ...
          {/* Bottom nav bar */}
          <div className="flex items-center justify-around px-6 py-3 border-t border-[#18181B] bg-[#09090B]">
